...
def getSnowBlue (wd,inras,outras,plotting=False,sigma=3,blueband=1,meanbluethresh=0.70):
    '''
    ...
    if (tif.RasterCount >1): #here we are making sure that tif is a true color image.
        ...
        if meanblue <(meanbluethresh*10000):
...
wd=r'C:\Users\361045\Documents\projects\ngee\manuscipts\snowRemoteSensing\maps\TresholdExample\NorthSlopeAK_02282022_psscene_analytic_sr_udm2'
...
for f in flist: ##we're going to loop through the tifs in the directory and calculate snow on the true color images
    ...
    getSnowBlue(wd,inras,outras,True)
