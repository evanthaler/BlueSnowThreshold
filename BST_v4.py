...
def BST (wd,inras,outras,plotting=False,blueband=1,meanbluethresh=0.70,nosnowthresh=0.01,scalingFactor=10000,nd=0.):
    '''  
    Parameters
    ----------
    wd : string
    ...
    scalingFactor : float, optional
        ...
        If an image is not scaled or has a range 0-255, then scalingFactor=1
        The default is 10000
    nd : float, optional
        No data value for the raster if none is given in the metadata
        The default is 0.
    Returns
    -------
    None.
